...
describe('Credential', () => {
	test('discriminates password by kind', () => {
	...
	test('tokenProvider is an async function the driver will call', async () => {
		let calls = 0;
	...
	test('driverNative accepts any shape on config', () => {
		const cred: Credential = {
			kind: 'driverNative',
