...
test('PROCESS_TAG — 8 lowercase hex chars', () => {
	assert.match(PROCESS_TAG, /^[0-9a-f]{8}$/)
})
...
test('nextId — counters are independent across prefixes', () => {
...
test('nextId — custom generator shares the counter state with defaults', () => {
