...
test('MssqlError — message, name, instanceof Error', () => {
...
test('MssqlError — connectionId/queryId/poolId populated when given', () => {
...
test('MssqlError — fields absent when not provided', () => {
...
test('MssqlError — preserves ES2022 cause', () => {
